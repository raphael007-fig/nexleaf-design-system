...
export const STATE_SECTIONS = [
  ...
  },
  {
    ...
    states: [
      ...
      { id: 'lab-submitting', label: '6 · Saving — in progress', render: () => <AssembledLabApp persona="lead" initialView="createlab" createLabProps={{ state: 'review', seed: 'hosted', simulate: 'submitting' }} /> },
      { id: 'lab-submit-failed', label: '6 · Save failed — nothing created', render: () => <AssembledLabApp persona="lead" initialView="createlab" createLabProps={{ state: 'review', seed: 'hosted', simulate: 'submit-failed' }} /> },
      { id: 'lab-cancel-confirm', label: 'Cancel — discard confirm', render: () => <AssembledLabApp persona="lead" initialView="createlab" createLabProps={{ state: 'identification', seed: 'hosted', simulate: 'cancel-confirm' }} /> },
