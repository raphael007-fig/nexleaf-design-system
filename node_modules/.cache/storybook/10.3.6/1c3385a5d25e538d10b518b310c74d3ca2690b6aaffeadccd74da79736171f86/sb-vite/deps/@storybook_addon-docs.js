...
import { C as definePreviewAddon10 } from "./components-hQPfje5S.js";
import { t as DocsRenderer } from "./chunk-OATZR77O-BV7Gw0lq.js";
...
var excludeTags = Object.entries(globalThis.TAGS_OPTIONS ?? {}).reduce((acc, entry) => {
	...
	renderer: async () => {
		let { DocsRenderer } = await import("./DocsRenderer-LL677BLK-fCNFEb3t.js");
